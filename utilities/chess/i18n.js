...
const ChessI18n = (() => {
    const strings = {
        en: {
            ...
            variants_desc: 'Coming Soon',
            settings_title: 'Settings',
            settings_desc: 'Language, themes & preferences',
            online_title: 'Play Online (PvP)',
            online_desc: 'Play with a friend via room code',
            online_pvp: 'Online PvP',
            online_choice: 'Create a new game or join one',
            create_game: 'Create Private Game',
            create_desc: 'Get a code to share with a friend',
            join_game: 'Join via Code',
            join_desc: 'Enter a code from your friend',
            join_btn: 'Join Game',
            ...
            config_desc: 'Choose your side and game rules',
            play_as: 'Play As',
            random: 'Random',
            variant: 'Variant',
            save_btn: 'Save',
        ...
        fr: {
            ...
            variants_desc: 'Bientôt disponible',
            settings_title: 'Paramètres',
            settings_desc: 'Langue, thèmes et préférences',
            online_title: 'Jouer en ligne (PvP)',
            online_desc: 'Jouer avec un ami via un code de salon',
            online_pvp: 'PvP en ligne',
            online_choice: 'Créez une nouvelle partie ou rejoignez-en une',
            create_game: 'Créer une partie privée',
            create_desc: 'Obtenez un code à partager avec un ami',
            join_game: 'Rejoindre via un code',
            join_desc: 'Saisissez le code de votre ami',
            join_btn: 'Rejoindre',
            share_code: 'Partagez ce code avec votre ami :',
            waiting_opponent: 'En attente de l\'adversaire...',
            copy_code: 'Copier',
            code_copied: 'Copié !',
            soon_badge: 'Bientôt',
            config_room: 'Configuration du Salon',
            config_desc: 'Choisissez votre camp et les règles',
